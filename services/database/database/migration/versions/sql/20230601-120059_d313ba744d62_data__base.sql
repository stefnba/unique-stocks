/* UP */
CREATE TABLE IF NOT EXISTS "data"."timezones"(
    timezone varchar PRIMARY KEY,
    created_at timestamp without time zone DEFAULT (now() at time zone 'utc'),
    updated_at timestamp without time zone
);

CREATE TABLE IF NOT EXISTS "data"."currencies"(
...
CREATE TABLE IF NOT EXISTS "data"."countries"(
    ...
    currency char(2) REFERENCES "data"."currencies"(id) NOT NULL,
