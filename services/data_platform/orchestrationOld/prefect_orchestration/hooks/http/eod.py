...
class EodHistoricalDataHook(BaseHttpHook):
    ...
    def exchanges(self):
        ...
        return self.make_request("exchanges-list", response_model=ExchangeModel)

    def exchange_listied_securities(self, exchange_code: str):
        """
    ...
    def historical_rates(self, symbol: str, exchange_code: str):
        ...
        return self.make_request(
            ...
            response_model=HistoricalRatesModel,
        )
