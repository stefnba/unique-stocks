...
def create_async_http_client(tcp_connector_limit=50) -> aiohttp.ClientSession:
    """
...
class Counter:
    """Counter that logs the progress of the async tasks every iteration as defined by `step` param."""
