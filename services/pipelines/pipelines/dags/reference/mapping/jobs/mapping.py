...
import polars as pl
from dags.reference.mapping.jobs.config import MappingFinalPath, MappingPath
...
class MappingJobs:
    ...
    def curate(file_path: str):
        ...
        datalake_client.upload_file(
            destination_file_path=MappingPath(zone="curated"),
            file=file_content,
        )
        # final reference
        datalake_client.upload_file(
            destination_file_path=MappingFinalPath(),
            file=file_content,
        )
