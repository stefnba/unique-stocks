...
export default function ExchangeOneInfo() {
    ...
    return (
        <Descriptions layout="vertical" colon={false} className="mt-6">
            ...
            <Descriptions.Item label="Country">{country_id}</Descriptions.Item>
            <Descriptions.Item label="Country">{is_active}</Descriptions.Item>
            <Descriptions.Item label="Virtual">{is_virtual}</Descriptions.Item>
